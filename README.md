...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/6074be72b482fb00162d0974
...
To start editing your site, you can use the Sanity interface at https://happy-plankton-4be72.sanity.studio/.
...
Generated at `2021-04-12T21:42:10.530Z` by Stackbit version `0.3.50`.